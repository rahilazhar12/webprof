                ...
                <div className="bg-white p-10 rounded-lg shadow-lg w-full max-w-full mx-auto">
                    ...
                    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="flex items-center justify-center w-full col-span-3">
                            <label className="flex flex-col items-center px-4 py-2 bg-white text-blue-600 rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue-600 hover:text-white">
                                <Icon icon="mdi:upload" className="h-8 w-8" />
                                <span className="mt-2 text-base leading-normal">Select a Profilepic</span>
